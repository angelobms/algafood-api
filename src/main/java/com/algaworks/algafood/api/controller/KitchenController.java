...
public class KitchenController {
	...
	public Page<KitchenModel> list(@PageableDefault(size = 10) Pageable pageable) {
		...
		List<KitchenModel> kitchensnModel = kitchenModelAssembler.toCollectionModel(kitchens.getContent());
		Page<KitchenModel> kitchensnModelPage = new PageImpl<>(kitchensnModel, pageable, kitchens.getTotalElements());
		
		return kitchensnModelPage;
	}
